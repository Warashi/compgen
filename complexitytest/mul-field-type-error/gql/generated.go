...
type ComplexityRoot struct {
	...
	Query struct {
		Foo func(childComplexity int, a *int, b *string) int
	}
}

type QueryResolver interface {
	Foo(ctx context.Context, a *int, b *string) (*model.FooConnection, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.foo":
		...
		return e.complexity.Query.Foo(childComplexity, args["a"].(*int), args["b"].(*string)), true
...
func (ec *executionContext) _Query_foo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Foo(rctx, fc.Args["a"].(*int), fc.Args["b"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
